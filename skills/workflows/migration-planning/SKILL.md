...
description: Plan a risky migration — schema migration, service decomposition, library upgrade, or architecture change — with step-by-step execution, rollback procedures, and risk register
argument-hint: "[what is changing, why, scope of affected systems, constraints: downtime budget, data volume, timeline]"
...
- Are there new requirements or opportunities to address during migration?

**3. Migration Strategy**

Choose and justify one:
- **Big bang**: Everything changes at once. When is this appropriate?
- **Incremental**: Gradual migration over multiple deployments. How do you handle intermediate states?
...
- How much data?
- Can it be done online (while running) or offline?
...
**7. Testing Strategy**
- How do you test the migration before production?
- Can you run it against a copy of production data?
- What automated checks verify success?
...
4. A risk register (what could go wrong and how likely).
