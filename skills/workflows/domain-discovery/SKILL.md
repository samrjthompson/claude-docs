...
description: Extract and organise domain knowledge from raw material — entities, relationships, workflows, business rules, glossary, roles, and a recommended domain model
argument-hint: "[paste interview notes, business process descriptions, documentation, or describe the domain verbally]"
...
Extract and organise domain knowledge from raw material into a structured model ready for software design.

## Raw Material

$ARGUMENTS

(If the above is insufficient, provide: interview notes, business process descriptions, existing documentation, or a verbal explanation of the domain.)
...
- Are there entities that seem important but are not well-defined? Flag these as needing clarification.
