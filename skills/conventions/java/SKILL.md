...
description: Java/JVM naming and structural conventions — packages, naming, exception hierarchy, testing, MDC logging, Javadoc, Bean Validation, Spring Security, Keycloak
...
Java/JVM naming and structural conventions. Complements the universal engineering standards.
