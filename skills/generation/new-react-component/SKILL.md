...
description: Generate a reusable React component with TypeScript props interface, Tailwind styling, and a test file
argument-hint: "[ComponentName] [feature|shared] [purpose description] [props: name:type:required? ...] [variants if any]"
...
- **Variants** (if applicable): Visual or behavioural variants (e.g., `primary`, `secondary`, `danger`)
